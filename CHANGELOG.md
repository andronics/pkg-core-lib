...
All notable changes to @core/lib will be documented in this file.
...
- Declared external command requirements: yq
...
- Package naming now includes collection scope: `@core/lib`
